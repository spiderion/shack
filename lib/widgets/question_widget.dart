...
import 'package:shack/screens/questions/write_answer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: Theme.of(context).focusColor.withOpacity(0.1), blurRadius: 15, offset: Offset(0, 5)),
          ],
        ),
        child: Stack(
          children: <Widget>[
              ...
              child: FlatButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                      CupertinoPageRoute(
                        builder: (context) => WriteAnswer(model: model),
                      ),
                    );
                  },
                  child: Container(
